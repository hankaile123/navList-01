...
$(function () {
  ...
  var render = function render() {
    ...
    hashMap.forEach(function (item, index) {
      ...
      var $li = $("\n            <li>\n                <div class=\"site\">\n                    <div class=\"logo\">\n                        <span> \n                            ".concat(simplify(item.url)[0].toUpperCase(), "\n                        </span>\n                    </div>\n                    <div class=\"url\">\n                        <span>").concat(simplify(item.url), "</span>\n                    </div>\n                    <div class=\"functionList\">\n                    <svg class=\"icon\" aria-hidden=\"true\">\n                            <use xlink:href=\"#icon-remove2\"></use>\n                        </svg>\n                    </div>\n                </div>\n            </li>\n        ")).insertBefore($('.add').parent());
      $li.on('click', function () {
        window.open(item.url, '_self');
      });
      $li.on('click', '.functionList', function (e) {
        e.stopPropagation(); // 删除功能， 删的是数据，不是元素
  ...
  $(document).on('keyup', function (e) {
    var key = e.key;
    hashMap.forEach(function (items, index) {
